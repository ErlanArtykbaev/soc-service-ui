                    ...
                    <div className={''}>
                        <div className="row">
                            <div className={'col-sm-12 col-md-8  feedback_inLeftBlock'}>
                                <div><h3 className={'baseLightBlueColor'}>Всегда на шаг впереди</h3>
                                    <br/>
                                    <br/>
                                    <p className={'d-block px-20 fw-400'}>«Сегодня, когда компания оступается, она сразу слышит за собой дыхание конкурентов, поскольку в современном бизнесе не ходят, а бегают.»</p>
                                    <p className={'d-block text-right px-20 fw-500'}>Джек Траут</p></div>
                                <div>
                                    <h5 className={'fw-500 px-20 baseGrayColor'}>Наши портнеры</h5>
                                    <img className={'feedback_ourPartnersImage'} src={ourPartners} alt="our partners"/>
                                </div>
                                ...
                                <div className={'feedback_emailUs'}>
                                    ...
                                    <form action="" className={'feedback_form row'}>
                                        ...
                                        <div className="form-group col-sm-12 col-md-12 py-2">
                                            <div className="wrap">
                                                <div className="group feedback_fieldLabel baseGrayColor ">
                                                    <input type={'text'} className={'feedback_textarea'}id=""/>
