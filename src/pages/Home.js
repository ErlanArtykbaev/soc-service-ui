        ...
        <div className='home'>
            ...
            <section className="container">
                <div className="row row--large-gutter@xl-up u-pad-ends-small@lg-up u-pad-ends-2xsmall@ms-down">
                    <TechnologiesCard title={'Expertise in'} subtitle={'backend development'} description={'We can provide\n' +
                    ...
                    '                API design and DevOps.'} WeUse={<WeUseCard stacks={['PHP', 'JS', 'NodeJs', 'C#', 'Rust', 'Python', 'Django', 'Java', '.NET', 'React', 'VueJS', 'AngularJS']}/>}/>
                    <TechnologiesCard title={'Expertise in'} subtitle={'backend development'} description={'We can provide\n' +
                    '                language-agnostic development,\n' +
                    '                SOLID development, test-driven development, RESTFul API, scalable\n' +
                    '                architecture, third-party\n' +
